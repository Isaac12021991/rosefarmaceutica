...
class Estado_rose extends CI_Controller {
    function __construct() {
        parent::__construct();
        $this->load->model('estado_rose_model', 'estado_rose_model');
    ...
    public function mobile_index() {
        ...
        $data['mi_estado'] = $this->estado_rose_model->get_mi_estado_model();

        $this->load->view('layout/header_view', $data);
        $this->load->view('estado_rose/estado_rose_main_mobile_view');
        $this->load->view('estado_rose/footer_estado_rose_view');
        ...
        $this->load->view('estado_rose/estado_rose_main_desktop_view', $data);
