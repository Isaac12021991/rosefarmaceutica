    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
            ...
            <span class="mt-10 d-block d-md-none">
                    <div class="footer bg-white pb-3 pt-1 mt-4 d-flex flex-lg-column" id="kt_footer"  style="bottom:0; position:fixed; width:100%; z-index:1;">
            <!--begin::Container-->
        ...
        <?php endif; ?>
          ...
          <?php if($this->usuario_library->permiso_tipo_empresa("'DROGUERIA','FARMACIA','CLINICA'")): ?>   
           ...
           <a href="<?= site_url('/compra/orden_compra') ?>" data-animsition-out-class="fade-out" data-animsition-out-duration="200" class="animsition-link btn mt-0  btn-link-dark btn-block"><i id="nav_movil_compras" class="fas fa-shopping-cart icon-xl"></i>  <span id="nav_movil_compras_notificacion" style="margin-left:-20px; margin-top:24px; position: absolute;"  class="" ></span>  </a>
