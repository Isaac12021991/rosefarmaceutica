...
<div class="row animated fadeIn">
                                  ...
                                  <div class="portlet box bg-blue-chambray">
                                    <div class="portlet-title">
                                        <div class="caption">
                                        Inventario movimiento por precio y cantidad de productos </div>
                                        <div class="actions">
  ...
  $('#response_submain').html('<div class="loader_panel_inside"> <div class="ball"></div><h6 align="center"><B>CARGANDO DETALLE... ESPERE POR FAVOR</b></h6></div><br> <h3 align="center"><b>DROGUERIA SOFIMED C.A.</b></h3>');
    ...
    var ff_hasta = $('#ff_hasta').val();
      ...
      $.ajax({
        ...
        url: "<?php echo site_url('reportes/reporte_movimiento_inventario_2_submain') ?>",
        beforeSend: function(){  },
                     }).done(function( data ) { 
...

{
    ...
    var ff_hasta = $('#ff_hasta').val();
      ...
      $.ajax({
        method: "POST",
        data: {'ff_desde':ff_desde, 'ff_hasta':ff_hasta},
        url: "<?php echo site_url('reportes/reporte_movimiento_inventario_2_submain_excel') ?>",
        beforeSend: function(){  },
                     }).done(function( data ) { 
