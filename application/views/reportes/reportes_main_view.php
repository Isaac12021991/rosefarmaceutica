            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                  ...
                  <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                     <div class="panel-body">
                        <table width="100%">
                           <tr>
                              <td width="90%"><a onclick="ejecucion_mensual()"> <span class="items_menu" id="ejecucion_mensual"> Ejecucion Mensual</span> </a></td>
                              <td width="10%"></td>
                           </tr>
                        </table>
                     </div> 
                  ...
                  <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                     <div class="panel-body">
                        <table width="100%">
                           ...
                           <tr>
                              <td width="90%"><a onclick="reporte_documento_mensual()"> <span class="items_menu" id="reporte_documento_mensual"> Pagos Asociados</span> </a></td>
                              <td width="10%"></td>
                           </tr>
                           <tr>
                              <td width="90%"><a onclick="reporte_documento_planvsreal()"> <span class="items_menu" id="reporte_documento_planvsreal"> Plan Vs Real</span> </a></td>
                              <td width="10%"></td>
                           </tr>
                           <tr>
                              <td width="90%"><a onclick="reporte_factura_producto_mensual()"> <span class="items_menu" id="reporte_factura_producto_mensual"> Productos Facturados</span> </a></td>
                              <td width="10%"></td>
                           </tr>
                        </table>
                     </div>
...
<script type="text/javascript"> 
   ...
   function reporte_documento_planvsreal(){
   
   $("#controllers_reportes").load('<?php echo site_url('reportes/reporte_planvsreal_main') ?>');
   $(".items_menu").removeAttr('style');
   $("#reporte_documento_planvsreal").css({'font-weight':'bold'});
   
   }

   function reporte_factura_producto_mensual(){
   
   $("#controllers_reportes").load('<?php echo site_url('reportes/reporte_facturadomes_main') ?>');
   $(".items_menu").removeAttr('style');
   $("#reporte_factura_producto_mensual").css({'font-weight':'bold'});
   
   }
   function ejecucion_mensual(){
   $("#controllers_reportes").load('<?php echo site_url('reportes/ejecucion_mensual_main') ?>');
   $(".items_menu").removeAttr('style');
   $("#reporte_factura_producto_mensual").css({'font-weight':'bold'});
