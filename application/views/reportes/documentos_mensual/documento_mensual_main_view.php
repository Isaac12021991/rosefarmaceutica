...
<div class="row animated fadeIn">
                                  ...
                                  <div class="portlet box bg-blue-chambray">
                                    <div class="portlet-title">
                                        <div class="caption">
                                        Documentos con Pagos Asociados </div>
                                        <div class="actions">
                                      ...
                                      <div class="row">
                                                                ...
                                                                <div class="col-md-2">
                                                                 ...
                                                                 <div class="col-md-2">
                                                                  ...
                                                                  <a href="javascript:;" onclick="buscar_documento_mensual()" class="btn default align-middle"> <li class="fa fa-search"></li> </a>
...
function buscar_documento_mensual()
  ...
  $('#response_submain').html('<div class="loader_panel_inside"> <div class="ball"></div><h6 align="center"><B>CARGANDO DETALLE... ESPERE POR FAVOR</b></h6></div><br> <h3 align="center"><b>DROGUERIA SOFIMED C.A.</b></h3>');
    ...
    var ff_hasta = $('#ff_hasta').val();
      ...
      $.ajax({
        ...
        url: "<?php echo site_url('reportes/reporte_documento_mensual_submain') ?>",
        beforeSend: function(){  },
                     }).done(function( data ) { 
