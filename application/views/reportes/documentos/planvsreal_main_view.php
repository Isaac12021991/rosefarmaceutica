      ...
      <div class="portlet box bg-blue-chambray">
        ...
        <div class="portlet-body">
          <div class="row">
            ...
            <div class="col-md-2">
              <div class="form-group">
                <select class="form-control input-sm" id="co_tipo_plan" name="co_tipo_plan">
                  <option value="1">Original</option>
                  <option value="2">Modificado</option>
                </select>                                                                      
                <span class="help-block"> Tipo Plan </span>
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group">
                <input id="ff_desde" name="ff_desde" class="form-control input-sm from" placeholder="Mes" type="text">
...
function buscar() {
  ...
  $('#response_submain').html('<div class="loader_panel_inside"> <div class="ball"></div><h6 align="center"><B>CARGANDO DETALLE... ESPERE POR FAVOR</b></h6></div><br> <h3 align="center"><b>DROGUERIA SOFIMED C.A.</b></h3>');
    ...
    var ano = ff_desde.substring(3,7);
        var co_tipo_plan = $('#co_tipo_plan').val();

    $.ajax({
        method: "POST",
        data: {'mes':mes, 'ano':ano, 'co_tipo_plan':co_tipo_plan},
