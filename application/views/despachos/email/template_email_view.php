                      ...
                      <tr>
                        ...
                        <td  align='center' width='530'>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class="contentEditable" style='font-size:32px;color:#555555;font-weight:normal;'>Venta culminada</div>
                          </div>
                        </td>
                        <td  width='70'></td>
                      </tr>
                        ...
                        <td  align='center' width='530'>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class="contentEditable" style='font-size:13px;color:#99A1A6;line-height:19px;'>
                              Felicidades venta culminada</div>
                          </div>
                        </td>
                        <td  width='70'></td>
                      </tr>
                            ...
                            <td width='475' valign='middle'>
                              <div class='contentEditableContainer contentTextEditable'>
                                <div class="contentEditable" style='font-family:Georgia;font-style:italic;color:#0F4666;font-size:15px;line-height:19px;'>
                                  <p style='color:#0F4666;'>presidencia@sofimed.com.ve</p>
                                </div>
                              </div>
                            </td>
      ...
      <td align='left' valign='top' width='370' class="specbundle3">
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class="contentEditable" style='color:#ffffff;font-size:21px;line-height:19px;'>
                                      <p ><span class="font">Felicitaciones, venta culminada con éxito</p>
                                    </div>
                                  </div>
                                </td>
...
Felicitaciones <b><?php echo $nombre; ?> <?php echo $apellido; ?></b>, nos complace notificarle que se ha completado el proceso de venta del presupuesto n° <b> <?php echo $nu_codigo_presupuesto; ?> </b>; esta a su vez a generado la <?php echo $nb_documento; ?> N°  <?php echo $nu_documento; ?>, para el cliente <?php echo $nb_cliente; ?> por un monto de <?php echo number_format($nu_precio_factura,2,',','.'); ?> BsS.
<br />

  <h2 class='big' align="center">Comisión por esta venta:</h2>
  <br>
  <h1 class='big' align="center"><i><b> 
  <?php echo number_format($porcentaje_ganancia,2,',','.'); ?> BsS.</b></i></h1>
  <br />
  
  <p align="center">Cualquier duda o inconveniente por favor comunicarse con el equipo de venta a traves del siguiente correo: <i>administracion@sofimed.com.ve</i>. </p>
                    ...
                    <td valign='top' align='center'>
                      <div class="contentEditableContainer contentTextEditable">
                        <div class="contentEditable" style='color:#A8B0B6; font-size:13px;line-height: 16px;'>
                          <p >Este e-mail fue enviado por: ventas@sofimed.com.ve – Drogueria Sofimed  C.A. Venezuela, Av. Monte Bello, Calle L entre Av 11 y 12, Zulia (Maracaibo),  RIF J-40998224-4, Venezuela.<br />
                            Para asegurarse de recibir los mensajes agregue presidencia@sofimed.com.ve  a su libreta de direcciones o contactos.</p>
</div>
                      </div>
                      </td>
                    </tr>
                      ...
                      <td valign='top' align='center'>
                        ...
                        <div class="contentEditableContainer contentTextEditable">
                          <div class="contentEditable" >
                            ...
                            Ayuda y soporte <br>
      Contactenos a: presidencia@sofimed.com.ve
                            </a>
                          </div>
                        </div>
