...
class PDF extends FPDF 
{
  ...
  var $angle=0;
    ...
    function Header()
    {
        ...
        $this->Cell(40,4,utf8_decode($this->operacion),0,1,'R');
        endif;
    ...
    function TablaBasica($info_documento_general)
       {
        //Cabecera
            ...
            $this->SetFont('Arial','B',8);  
            $this->Cell(30,5,"ALMACEN DESTINO:",0);
           ...
           $this->SetXY($x+0, $y-0);
            ...
            $this->SetFont('Arial','B',8); 
            $this->Cell(20,5,utf8_decode('OPERACION'),0,0,'R');
            ...
            $this->Cell(20,5,utf8_decode($this->tx_descripcion_movimiento),0,0,'L');
  ...
  $this->Cell(0,5,"Operacion de inventario",0,0,'L');
...
$pdf = new PDF('P', 'mm', 'Letter');
    ...
    $row_general = $info_documento_general;

    $co_almacen =  $row_general->co_almacen;
    $pdf->operacion = $row_general->tx_tipo_operacion;
    ...
    $pdf->nombre_encargado = $row_general->first_name.' '.$row_general->last_name;
    $pdf->info_documento_detalle = $info_documento_detalle;

    $pdf->tx_descripcion_movimiento = $row_general->tx_descripcion_movimiento;
