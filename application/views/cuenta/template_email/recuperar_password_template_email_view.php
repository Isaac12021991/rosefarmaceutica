...
<body paddingwidth="0" paddingheight="0" bgcolor="#d1d3d4"  style="padding-top: 0; padding-bottom: 0; padding-top: 0; padding-bottom: 0; background-repeat: repeat; width: 100% !important; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;" offset="0" toppadding="0" leftpadding="0">
  ...
  <tbody>
    <tr>
      <td valign="top" width="250">ROSE</td>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              <h2 style="font-size: 20px;"><b>ROSE - Restablecer la contraseña</b></h2>
                              <br>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                              ...
                              Contactanos<br/>
                              admision@rosefarmaceutica.com<br> <br>                     
                              </p><br>

<br>
<p style="font-size: 10px;" align="center">

Este e-mail fue enviado por: admision@rosefarmaceutica.com – ROSE - Venezuela.
Para asegurarse de recibir los mensajes agregue admision@rosefarmaceutica.com  a su libreta de direcciones.</p>
