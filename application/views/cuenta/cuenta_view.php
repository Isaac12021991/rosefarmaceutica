                                    ...
                                    <h5 id="controlador" class="text-dark font-weight-bold mt-2 mb-2 mr-5">Perfil</h5>
                                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                            <li class="breadcrumb-item text-muted">
                                                <a href="javascript:" class="text-muted">Informacion Personal</a>
                                            </li>
                                        </ul>
                                            ...
                                            <div class="card-body pt-4">
                                                ...
                                                <div class="py-9">
                                                    ...
                                                    <div class="navi-item mb-2">
                                                        <a href="<?php echo site_url("cuenta/cuenta"); ?>" class="navi-link py-4 active">
                                ...
                                <div class="col-lg-8 pt-lg-0 pl-lg-4 pr-lg-4 pt-2 pl-0 pr-0">
                                            ...
                                            <div class="card-header py-3">
                                                <div class="card-title align-items-start flex-column">
                                                    ...
                                                    <span class="text-muted font-weight-bold font-size-sm mt-1">Actualize su informacion personal</span>
                                                </div>
                                ...
                                <span class="form-text text-muted">Indique su numero de WhatsApp.</span>
                                                 ...
                                                 <div class="separator separator-dashed my-5"></div>
                                                    ...
                                                    <div class="row">
                                                        <label class="col-xl-3"></label>
                                                        <div class="col-lg-9 col-xl-6">
                                                            <h5 class="font-weight-bold mb-6">Dispositivos vinculados:</h5>
                                                        </div>
                                                    </div>
                                                    <!--begin::Form Group-->
                                                    <!--begin::Form Group-->
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="card-body pt-2">
                                                                ...
                                                                <?php if($info_dispositivos_vinculados->num_rows() > 0): ?>


                                                                    <?php foreach ($info_dispositivos_vinculados->result() as $row): ?>

                                                <!--begin::Item-->
                                                <div class="d-flex align-items-center mb-4">
                                                    <!--begin::Bullet-->
                                                    <?php if ($row->id_session == session_id()): ?>
                                                ...
                                                <?php endif; ?>
                                                    ...
                                                    <div class="d-flex flex-column flex-grow-1 ml-5">
                                                        <a href="javascript:" class="text-dark-75 text-hover-primary font-weight-bold font-size-lg mb-1"><?php echo $row->nb_navegador; ?> (<?php echo $row->nb_os; ?>)</a>
                                                        <?php if ($row->id_session == session_id()): ?>
                                                            <span class="text-success font-weight-bold">Activo</span>
                                                        <?php endif; ?>
                                                        <span class="text-muted font-weight-bold">IP: <?php echo $row->ip; ?></span>
                                                    </div>
                                                    <!--end::Text-->
                                                    <!--begin::Dropdown-->
                                                    <?php if ($row->id_session != session_id()): ?>
                                                    <a href="javascript:" onclick="quitar_dispositivo_vinculado('<?php echo $row->id; ?>')" class="btn btn-sm btn-light-primary p-2"> Quitar</a>
                                                        <?php endif; ?>
                                                    <!--end::Dropdown-->
                                                </div>
                                            ...
                                            <?php endif; ?>
                                                ...
                                                <!--end::Item-->
                                                    ...
                                                    <div class="row">
                                                        <label class="col-xl-3"></label>
                                                        <div class="col-lg-9 col-xl-6">
                                                            <h5 class="font-weight-bold mb-6">Seguridad:</h5>
                                                        </div>
                                                    </div>
                                                    <!--begin::Form Group-->
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">Clave del sistema</label>
                                                        <div class="col-lg-9 col-xl-6">
                                                            <a onclick="abrir_contrasena_modal()" class="btn btn-light-primary font-weight-bold btn-sm">Cambiar clave</a>
                                                            <p class="form-text text-muted pt-2">Si desea cambiar la clave de acceso al sistema haga clic en cambiar clave.
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <!--begin::Form Group-->
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">Eliminar cuenta</label>
                                                        <div class="col-lg-9 col-xl-6">
                                                            <p class="form-text text-muted py-2">Si desea darse de baja en Rose haga clic en eliminar cuenta.</p>
                                                            <a onclick="abrir_eliminar_cuenta_modal()" class="btn btn-light-danger font-weight-bold btn-sm">Eliminar cuenta</a>
                                                        </div>
                                                    </div>
 ...
 $('#actualizar_usuario').click(function(){
   ...
   function quitar_dispositivo_vinculado(co_user_session)
   {
   
   
                                              $.ajax({
   method: "POST",
   data: {'co_user_session':co_user_session},
   url: "<?php echo site_url('cuenta/eliminar_dispositivo_vinculado') ?>",
   beforeSend: function(){  },
            }).done(function( data ) { 
