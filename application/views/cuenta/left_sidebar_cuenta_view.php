              ...
              <?php endif; ?>
               ...
               <?php if($this->usuario_library->permiso_tipo_empresa("'FARMACIA','CLINICA'")): ?> 
                <?php if($this->usuario_library->permiso_empresa("'Administrador','Bioenlace'")): ?>
                            ...
                            <li id="nav_cuenta"  class="nav-item start">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="icon-home"></i>
                                    <span class="title">Mi perfil</span>
                                    <span id="nav_cuenta_arrow" class="arrow"></span>
                                </a>
                                <ul class="sub-menu">
                                    <li class="nav-item start ">
                                        <a href="<?php echo site_url('partner/index')?>" class="nav-link ">
                                            <span class="title">Empresa</span>
                                        </a>
                                    </li>

                                    <li class="nav-item start ">
                                        <a href="<?php echo site_url('cuenta/cuenta')?>" class="nav-link ">
