                    ...
                    <td width="10%"></td>
                          ...
                          <tr>
                            ...
                            <td width="10%"></td>
                                                        ...
                                                        <tr>
                            <td width="90%"><a href="<?php echo site_url('cuenta_banco/listado_pagos')?>"> <span class="items_menu" id="cuentas_bancarias"> Pagos  </span> </a></td>
                            <td width="10%"></td>
                         </tr>
          ...
          <?php endif; ?>
                                ...
                                <div class="portlet light">
                                    <div class="portlet-body">
                                      <h4 class="font-blue">Todos los pagos</h4>
               ...
               <tbody>
                  ...
                  <tr <?php if($row->co_estatus == '55'): ?> class="font-blue" <?php endif; ?> <?php if($row->co_estatus == '57'): ?> class="font-red" <?php endif; ?>>
                    <td> <?php echo $row->tx_movimiento_pago; ?>  </td>
                      <?php $info_cuenta = $this->pagos_library->get_info_cuenta_banco_model($row->co_cuenta_banco); ?>
                    <td> <?php echo $info_cuenta->nb_diario; ?>
                    <br><span style="font-size:12px"><b><?php echo $info_cuenta->nb_moneda; ?></b></span>
                    <br><span style="font-size:10px"><?php echo $info_cuenta->tx_tipo_diario; ?></span>  </td>
                     <td> <?php echo $row->nu_referencia; ?>  </td>
                     <td><?php echo $row->ca_pago; ?> <?php echo $info_cuenta->nb_acronimo; ?></td>
