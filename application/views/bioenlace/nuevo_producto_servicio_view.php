                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
                            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                ...
                                <a onclick="nuevo_producto()"class="btn btn-light-primary font-weight-bolder btn-sm mr-2">Guardar</a>
                                    ...
                                    <div class="card card-custom gutter-b">
                                         <div class="card-header">
                                          <div class="card-title">
                                           <h3 class="card-label">
                                            Nuevo
                                            <small>Nuevo producto o servicio</small>
                                           </h3>
                                          </div>
                                         </div>
                                            ...
                                            <form class="form">
                                             <div class="card-body">
                                               ...
                                               <div class="col-9">
                                                 <input type="text" name="nb_producto" id="nb_producto" class="form-control form-control-solid" placeholder="Nombre" value=""> 
                                               </div>
                                              </div>
                                           ...
                                           <div class="col-lg-6">
                                              ...
                                              <div class="form-group row mb-2">
                                               ...
                                               <div class="col-9">
                                                <input type="text" name="ca_precio" id="ca_precio" class="form-control" placeholder="00.0" value="">
                                             ...
                                             <div class="form-group row mb-2">
                                               ...
                                               <div class="col-9">
                                <input type="text" name="ff_vence" id="ff_vence" class="form-control input-sm date_picker" autocomplete="off" placeholder="Vence" value="">   
...
<div class="tab-content mt-5" id="myTabContent">
    <div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel" aria-labelledby="kt_tab_pane_2">
                                               ...
                                               <div class="col-9">
                                                <input type="text" name="co_producto" id="co_producto" class="form-control" placeholder="Ejem 7000123456" value=""> 
                                               </div>
                                              </div>
...
var url = "<?php echo site_url('bioenlace/agregar_nuevo_producto_servicio') ?>";
