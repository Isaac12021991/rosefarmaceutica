                            ...
                            <div class="" id="notificacion_3" style="display: none;">
                                     ...
                                     <form class="form-horizontal" role="form">
                                      ...
                                      <input type="text" name="nb_direccion" id="nb_direccion" class="form-control input-sm input-medium" placeholder="Direccion">     
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
     											<input type="text" name="nu_telefono_local" id="nu_telefono_local" class="form-control input-sm input-small" placeholder="Telefono local">  
                                                    ...
                                                    <div class="col-md-9">
                                                       <input type="text" name="nu_telefono_movil" id="nu_telefono_movil" class="form-control input-sm input-small" placeholder="Telefono movil">  
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="cod_sicm" id="cod_sicm" class="form-control input-sm input-small" placeholder="Cod Sicm">   
                                                ...
                                                <div class="row">
                                                    ...
                                                    <a href="javascript:;" class="btn btn-default btn-sm" data-dismiss="modal" aria-hidden="true"> Cerrar</a>
                                                        <a onclick="agregar_sucursal()" class="btn blue-chambray btn-sm">Agregar</a>
          ...
          $('#notificacion_3').html('Ingrese el telefono movil');
           return;
                ...
                overlayCSS: { backgroundColor: '#fff' }
                               ...
                               $.ajax({
        method: "POST",
        data: {'nb_direccion':nb_direccion, 'nu_telefono_local':nu_telefono_local, 'nu_telefono_movil':nu_telefono_movil, 'cod_sicm':cod_sicm},
        url: "<?php echo site_url('empresa/agregar_sucursal_ejecutar') ?>",
        beforeSend: function(){  },
                     }).done(function( data ) { 
                 ...
                 $('#block').unblock();         
                  ...
                  $('#ajax_nueva_sucursal').modal('hide');
