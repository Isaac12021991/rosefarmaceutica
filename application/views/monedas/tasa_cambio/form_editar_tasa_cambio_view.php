                                ...
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Editar tasa de cambio</h4>
                                </div>
            ...
            ?>
               ...
               <div class="col-md-9">
                  <input type="text" name="ca_tasa_cambio" id="ca_tasa_cambio" class="form-control input-lg" placeholder="Monto" value="<?php echo $info_tasa_cambio->ca_tasa_cambio; ?>"> 
               </div>
            </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a onclick="actualizar_tasa_cambio()" class="btn blue">Guardar</a>
                                </div>
...
<script type="text/javascript">
   ...
   $('#co_moneda_tasa_cambio').val('<?php echo $info_tasa_cambio->co_moneda_tasa_cambio; ?>');

   function actualizar_tasa_cambio()
   {
                  var co_moneda = '<?php echo $co_moneda; ?>';
                  var co_tasa_cambio = '<?php echo $co_tasa_cambio; ?>';
       ...
       if (ca_tasa_cambio == '') {
           ...
           $('#ca_tasa_cambio').focus();
            return;
                                  ...
                                  $.ajax({
           method: "POST",
           data: {'co_moneda':co_moneda, 'co_tasa_cambio':co_tasa_cambio, 'co_moneda_tasa_cambio':co_moneda_tasa_cambio, 'ca_tasa_cambio':ca_tasa_cambio},
           url: "<?php echo site_url('monedas/actualizar_tasa_cambio') ?>",
           beforeSend: function(){  },
                        }).done(function( data ) { 
