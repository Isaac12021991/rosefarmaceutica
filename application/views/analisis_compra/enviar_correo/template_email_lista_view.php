                        ...
                        <tr>
                          <td align='left' valign='middle' >
                            <div class="contentEditableContainer contentImageEditable">
                              <div class="contentEditable" >
								                <font color="#FFFFFF"><b>SOFIMED.COM.VE</b></font>
                              </div>
                            </div>
                          </td>
                          ...
                          <td align='right' valign='top' >
                            <div class="contentEditableContainer contentTextEditable" style='display:inline-block;'>
                              <div class="contentEditable" >
                                <a href="#" style='color:#A8B0B6;font-size:13px;text-decoration:none;'>SIRE.</a>
                              </div>
                            </div>
                          </td>
                        ...
                        <td  align='center' width='530'>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class="contentEditable" style='font-size:32px;color:#555555;font-weight:normal;'>
                              <h2 style='font-size:32px;'>Lista de Precio</h2>
                            </div>
                          </div>
                        </td>
                        <td  width='70'></td>
                            ...
                            <td width='475' valign='middle'>
                              <div class='contentEditableContainer contentTextEditable'>
                                <div class="contentEditable" style='font-family:Georgia;font-style:italic;color:#0F4666;font-size:15px;line-height:19px;'>
                                  <p style='color:#0F4666;'>ventas@sofimed.com.ve</p>
                                </div>
                              </div>
                            </td>
                                          ...
                                          <td align='left' valign='top' width='370' class="specbundle3">
                                            <div class='contentEditableContainer contentTextEditable'>
                                              <div class="contentEditable" style='color:#ffffff;font-size:21px;line-height:19px;'>
                                                <p ><span class="font">Lista de Precio</p>
                                              </div>
                                            </div>
                                          </td>
                  ...
                  <td width="568" class="specbundle2">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" valign='top' >
                      ...
                      <tr>
                        <td align='left' valign='top'>
                          <div class="contentEditableContainer contentTextEditable" >
                            <div class="contentEditable" style='color:#000;font-size:13px;line-height:19px;'>
                                 
Reciba un cordial saludo de parte del equipo de ventas de la Drogueria Sofimed. C.A.  
la presente es, para ofrecerle la lista de medicamentos disponible en nuestra drogueria. 
El pago sera prepagado y/o contra el despacho.

<br />
<p align="center"><b>OFERTA DE PRODUCTO <?php echo $info_precios_lista->nu_codigo; ?> </b></p>
<p align="center"><?php echo date_user($info_precios_lista->ff_inicio) ?> al <?php echo date_user($info_precios_lista->ff_fin) ?></p><br>

<?php if ($tipo_salida == 0):  ?>
  <div class="row animated fadeIn">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
      
        <table class="table compact table-bordered table-hover" style="border-color:black;" width="100%" >
          <thead>
            <tr style='font-size:13px;color:#99A1A6;line-height:19px;'>
              <th width="5%" >N°</th>
              <th width="55%" align="center">PRODUCTO</th>
              <th width="20%" align="center">CATEGORIA</th>
              <th width="20%" align="center"><?php echo strtoupper($info_precios_lista->nb_moneda) ?></th>
            </tr>
          </thead> 
          <tbody>
            <?php $con = 0; foreach ($detalle_lista as $row) : $con ++; ?>
            <tr>
              <td> <?php echo $con; ?> </td>
              <td> <?php echo $row->nb_producto; ?></td>
              <td align="center">  <?php echo $row->nb_categoria; ?> </td>
              <td align="right"> <?php echo number_format($row->nu_precio_bs, 2, ',', '.'); ?> </td>
            </tr>
            <?php endforeach; ?>   
          </tbody>
        </table>
        ...
        <table class="table compact table-bordered table-hover" style="border-color:black;" width="100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td> <?php echo $row->nb_producto; ?></td>
              <td align="center">  <?php echo $row->nb_categoria; ?> </td>
              <td align="center">  <?php echo $row->nb_unidad_manejo; ?> </td>
              <td align="center">  <?php echo $row->nb_laboratorio; ?> </td>
              <td align="center">  <?php echo $row->ff_vencimiento; ?> </td>
              <td align="right"> <?php echo number_format($row->nu_precio_bs, 2, ',', '.'); ?> </td>
            </tr>
            <?php endforeach; ?>   
          </tbody>
...
<p align="center"><?php echo $observacion; ?></p>
...
<?php echo $nombre; ?>         
                      ...
                      <tr><td height='20'>&nbsp;</td></tr>
                      <tr>
                        <td align='right' valign='top' style='padding-bottom:8px;'></td>
                        
                      </tr>
                      <tr>
                        <td width="100%">
                          <div class="contentEditableContainer contentTextEditable">
                            <div class="contentEditable" style='color:#0A0A0A; font-size:13px;line-height: 16px;'>
                              <p> <b>NOTA IMPORTANTE:</b> No se haran devoluciones de mercancia por fecha de vencimiento, esta debe ser verificada por el cliente antes de realizar el pedido. </p>
                            </div>
                          </div>
                        </td>
                      </tr>
                  ...
                  <tr>
                    <td valign='top' align='center'>
                      <div class="contentEditableContainer contentTextEditable">
                        <div class="contentEditable" style='color:#A8B0B6; font-size:13px;line-height: 16px;'>
                          <p >Este e-mail fue enviado por: ventas@sofimed.com.ve – Drogueria Sofimed  C.A. Venezuela, Calle L entre Av 11 y 12, Urb Monte Bello, Maracaibo Edo Zulia,  RIF J-40998256-4, Venezuela.<br />
                            Para asegurarse de recibir los mensajes agregue ventas@sofimed.com.ve  a su libreta de direcciones o contactos.</p>
                        </div>
                      </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td valign='top' align='center'>
                        ...
                        <div class="contentEditableContainer contentTextEditable">
                          <div class="contentEditable" >
                            <a style='line-height: 20px;color:#A8B0B6; font-size:13px;'>
                              Ayuda y soporte <br>
                              Contactenos a: ventas@sofimed.com.ve
                            </a>
                          </div>
                        </div>
                      </td>
