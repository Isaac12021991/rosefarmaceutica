...
<div class="modal-header">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h5 align="center">Calificar a <?php echo $info_orden_compra->first_name.' '.$info_orden_compra->last_name; ?> de <?php echo $info_orden_compra->nb_empresa_vendedor; ?></h5>
        </div>
...
function calificar()
{
   ...
   var ca_calificacion = $(".rating").rate("getValue");
    ...
    if (ca_calificacion == '0') {
        ...
        url: "<?php echo site_url('compra/ejecutar_calificacion') ?>",
                     }).done(function( data ) { 
