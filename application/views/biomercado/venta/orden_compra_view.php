                                    ...
                                    <h5 id="controlador" class="text-dark font-weight-bold mt-2 mb-2 mr-5">Venta</h5>
                                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                            <li class="breadcrumb-item text-muted">
                                                <a href="" class="text-muted">Ordenes de venta</a>
                                            </li>
                                        </ul>
...
<?php if ($row->nb_estatus == 'Confirmado por el comprador'): ?>
            ...
            <span class="bullet bullet-bar bg-success align-self-stretch p-0 mr-0 blink"></span>
            
            <?php else: ?> <span class="bullet bullet-bar bg-dark align-self-stretch p-0 mr-0"></span>  
                ...
                <?php endif; ?>
                    ...
                    <div class="ml-2 d-flex flex-column w-200px mr-0">
                        <a href="<?php echo site_url("venta/detalle_orden_compra/$row->id");?>" class="text-dark-75 text-hover-primary font-weight-bold font-size-lg mb-0"> <?php echo $row->nu_codigo_orden_compra; ?> </a>
            ...
            <span class="d-none d-md-block">
             <div class="d-flex flex-column mr-12">
                ...
                <div class="p-0"><?php echo $row->nb_estado_comprador; ?> </div>
...
<a href="javascript:"  onclick="confirmar_orden_compra('<?php echo $row->id; ?>')" class="btn btn-success btn-sm mb-2 p-1 mr-2">
    <i class="far fa-check-circle"></i>
</a>

<a href="javascript:" onclick="cancelar_orden_compra('<?php echo $row->id; ?>')" class="btn btn-danger btn-sm p-1 mr-2">
...
<a href="javascript:" onclick="cancelar_solicitud('<?php echo $row->id; ?>')" class="btn btn-light-danger btn-sm font-weight-bold p-1 mt-1 mr-2"><i class="far fa-times-circle"></i></a>
