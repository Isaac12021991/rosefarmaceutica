                                          ...
                                          <div class="card-title">
                                           <h3 class="card-label">
                                            ...
                                            <form class="form">
                                             <div class="card-body">
                                               ...
                                               <div class="col-9">
                                                <select class="form-control js-example-basic-single" id="co_producto_publicaciones" name="co_producto_publicaciones" style="width: 100%">
                                           ...
                                           <div class="col-lg-6">
                                            ...
                                            <div class="form-group row mb-2">
                                               ...
                                               <div class="col-9">
                                                 <textarea class="form-control form-control-solid" id="tx_descripcion" name="tx_descripcion" placeholder="Descripcion de la promocion" maxlength="50"><?php echo $info_publicidad->tx_descripcion; ?></textarea>
                                               </div>
                                              </div>
...
<script type="text/javascript">
    ...
    $('#co_producto_publicaciones').val('<?php echo $info_publicidad->co_producto_publicaciones; ?>');
    $('#ca_dias').val('<?php echo $info_publicidad->ca_dias; ?>');
   ...
   function nueva_publicidad_industrial()
   {
     ...
     if (co_producto_publicaciones == '') {
           ...
           $('#nb_estado').focus();
            ...
            var url = "<?php echo site_url('publicidad/ejecutar_editar_nueva_publicidad_industrial') ?>";
