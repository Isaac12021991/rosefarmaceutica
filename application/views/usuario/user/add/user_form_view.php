                ...
                <div class="page-bar">
                            ...
                            <h4>Usuarios / Nuevo </h4>
                            <div class="page-toolbar pull-left">
                          
                            <a class="btn blue btn-sm" id="crear_usuario"> Guardar</a>
                    ...
                    <td width="10%"></td>
                                ...
                                <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-helper">nuevo usuario del sistema</span>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                             <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                      <input type="text" name="password" id="password" class="form-control input-sm input-medium" maxlength="15" placeholder="Password" maxlength="12">
                                                    </div>
                                                </div>


                                                  <div class="form-group">
                                                    <label class="col-md-3 control-label"><b>Confirmar contraseña</b></label>
                                      ...
                                      <div class="tabbable tabbable-tabdrop">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tab1">
                                                                                 <?php if($info_perfiles->num_rows() > 0):?>
                                        ...
                                        <div class="table-scrollable">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                 ...
                                                 <?php foreach ($info_perfiles->result() as $key): ?>
                                                    <tr>
                                                        <td> <input type="checkbox" class="checkbox_comprobar" name="accion_check[]" id="accion_check" value="<?php echo $key->id; ?>" /> </td>
 ...
 $('#crear_usuario').click(function(){
      ...
      notificacion_toas('error','Error','Ingrese un minimo de 6 caracateres en su contraseña');
      $('#nu_cedula').focus();
      return false;
    }
       ...
       if ($('#password').val() != $('#password_repeat').val()) {
         ...
         return;
             ...
             $.ajax({
        method: "POST",
      data: {'email':email, 'nu_cedula':nu_cedula, 'first_name':first_name, 'last_name':last_name, 'password':password,'accion_check':accion_check},
