                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            ...
                            <a class="btn blue btn-sm" id="guardar_perfil"> Guardar</a>
                    ...
                    <td width="10%"></td>
                                ...
                                <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-helper">perfil de usuario</span>
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                                            ...
                                            <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                ...
                                                <input type="text" id="nb_perfil" name="nb_perfil" placeholder="Nombre" class="form-control input-sm input-lg" value="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                    <textarea id="tx_descripcion" name="tx_descripcion" class="form-control" rows="2"></textarea>
                                                    </div>
                                                </div>
                             ...
                             <?php $info_privilegio = $this->usuario_library->get_permisos_privilegios($row->tx_modulo); 
  ...
  <script type="text/javascript">
        ...
        var tx_descripcion = $("#tx_descripcion").val();
          ...
          return;
              ...
              if (confirm("Estas seguro que deseas crear este perfil?"))
        ...
        {    
                ...
                $.ajax({
                       method: "POST",
                       data: {'accion_check':accion_check, 'nb_perfil':nb_perfil, 'tx_descripcion':tx_descripcion},
                       url: "<?php echo site_url('usuario/create_perfil')?>"
                     }).done(function( data ) { 

                    notificacion_toas('info','Perfiles','Perfil agregado');
